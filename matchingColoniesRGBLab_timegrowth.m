function[] = matchingColoniesRGBLab_timegrowth(folderpath)
...
%%
        ...
        dataReordered = struct('label', arraynew(:,1), 'sample', arraynew(:,2),...
            ...
            'area', double(arraynew(:,6)), 'diameter_t1', diameter, 'diameter_t0', diameter_t0, 'growth_rate', growth_rate, 'perimeter', double(arraynew(:,8)),...
            ...
            'Lab_mean', double(arraynew(:,23:25)), 'Lab_std', double(arraynew(:,26:28)), 'Labt_mean', double(arraynew(:,29:31)),...
            'Labt_std', double(arraynew(:,32:34)));
