...
[centers, radii, metric] = imfindcircles(croppedImage,[20, 60], 'Sensitivity',0.92, 'EdgeThreshold', 0.04);
%[centers, radii, metric] = imfindcircles(croppedImage,[20, 60],'Sensitivity',0.97);
%[centers, radii, metric] = imfindcircles(croppedImage,[150, 200],'Sensitivity',0.97);
